...
4. **Safety and correctness.** In the presence of unsafe code,
   ...
   be useful to impose additional usage constraints beyond those
...
part of its public interface. At present, though, it's quite invisible
...
- If a library forgets to implement all the relevant traits for a
  ...
  the counterbalance to the "forward compatibility" case made above:
